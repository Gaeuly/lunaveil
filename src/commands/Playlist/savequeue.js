...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
    ...
    if (!data) {
      return message.reply({
        embeds: [
          new EmbedBuilder()
            .setColor("2f3136")
            .setDescription(`<:1338107634812977253:1342912739101904926> | Playlist not found. Please enter the correct playlist name`),
        ],
      });
    }
    if (data.length == 0) {
    ...
    const embed = new EmbedBuilder()
      .setDescription(`<:1338107648524030063:1342912734634967195> | Added **${playlist.length - oldSong.length}** song in **${Name}**`)
