...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
    const msg = await message.channel.send(`<a:loading_pink2:1343939278056587308> | Turning on **Reset**. This may take a few seconds...`);
    ...
    const resetted = new EmbedBuilder()
        .setDescription(`<:1338107648524030063:1342912734634967195> | Filter Is Now **Disable**`)
        .setColor("2f3136");
